                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="currentPass" placeholder="Nhập mật khẩu hiện tại">
                            </div>
                            <br>
                            <div class="form-group">
                                <label for="insertPass">Mật khẩu mới</label>
                                <input type="password" class="form-control" id="insertPass" placeholder="Nhập mật khẩu mới" v-model="new_password">
                            </div>
                            <br>
                            <div class="form-group">
                                <label for="confirmPass">Nhập lại mật khẩu mới</label>
                                <input type="password" class="form-control" id="confirmPass" placeholder="Nhập lại mật khẩu" v-model="re_password">
