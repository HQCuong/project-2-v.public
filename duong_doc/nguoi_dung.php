 ...
 * -Lưu ý: <br>
 *     +Chức năng chỉ dành cho Giáo Vụ<br>
 *     +Cần gửi đầy đủ các dữ liệu được yêu cầu.<br>
 *     +Nếu SDT,Họ Tên,Mật Khẩu trống hệ thống sẽ tự tạo ngẫu nhiên.<br>
 * @apiSampleRequest http://localhost/project-2/public/api/nguoidung/tao
 * 
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/nguoidung/tao
 * {
 *     "key": "kdvkfJxgcd",
 *     "tai_khoan": "demo",
 ...
 * @apiSampleRequest http://localhost/project-2/public/api/dangnhap
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/dangnhap/test/d3d9446802a44259755d38e6d163e820
 ...
 * @apiSampleRequest http://localhost/project-2/public/api/dangxuat
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/dangxuat
 * {
 *     "key": "KEYAPI",
 * }
 * 
 ...
 * -Lưu ý: <br>
 *     +Chức năng dành cho tất cả user<br>
 *     +Cần gửi đầy đủ các dữ liệu được yêu cầu.<br>
 *     +Nếu trùng mật khẩu mới và cũ sẽ không thực hiện đổi.<br>
 * @apiSampleRequest http://localhost/project-2/public/api/nguoidung/doimatkhau
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/nguoidung/doimatkhau
 * {
 *     "key": "keyapi",
 ...
 * @apiSampleRequest http://localhost/project-2/public/api/nguoidung/reset
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/nguoidung/reset
 * {
 ...
 * @apiSampleRequest http://localhost/project-2/public/api/nguoidung/capnhatthongtin/{id}
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/nguoidung/capnhatthongtin/58
 * {
 *     "key": "keyapi",
 ...
 * -Lưu ý: <br>
 *     +Chức năng dàng cho tất cả Người Dùng 
 ...
 * @apiSampleRequest http://localhost/project-2/public/api/nguoidung/danhsach
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/nguoidung/danhsach
 * {
 *     "key" => "key",
 * }
 * 
 ...
 * -Các phương thức áp dụng Email,SDT,Tai_khoan<br>
 * -Lưu ý: <br>
 ...
 * @apiSampleRequest http://localhost/project-2/public/api/nguoidung/kiemtra
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/nguoidung/kiemtra
 * {
 *     "key": "Keyapi",
 *     "email" :"cds@gmail.com",
 *     "sdt": "1",
 ...
 * 
 * @apiSampleRequest http://localhost/project-2/public/api/nguoidung/kiemtrakey
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/nguoidung/kiemtrakey
 * {
 *     "key" => "key",
 * }
 * @apiParam {String} key Mã Key của người dùng.
 ...
 * @apiSampleRequest http://localhost/project-2/public/api/nguoidung/thongtin
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/nguoidung/thongtin
 * {
 *     "key": "key",
 *     "ma" :"58"
 * }
 ...
 * 	+Lấy thông tin của chính mình không cần truyền ma<br>
 * @apiSampleRequest http://localhost/project-2/public/api/nguoidung/clone
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/nguoidung/clone
 * {
 *     "key": "key",
 * }
 * @apiParam {String} key Mã Key của người dùng.
