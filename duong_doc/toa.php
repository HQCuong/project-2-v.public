 ...
 * 
 * @apiSampleRequest http://localhost/project-2/public/api/toa/hienthicactoa
 * 
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/toa/hienthicactoa
 * {
 *     "key": "1",
 *     "ma_toa":"2"
 * }
 ...
 * 
 * @apiSampleRequest http://localhost/project-2/public/api/toa/capnhat
 * 
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/toa/capnhat
 * {
 *     "key": "apikey",
 *     "ma_toa":"2",
 *     "ten_toa" : "Ten toa moi",
 ...
 * 
 * @apiSampleRequest http://localhost/project-2/public/api/toa/kiemtra
 * 
 * @apiExample {php} Truy Vấn Mẫu:
 * http://localhost/project-2/public/api/toa/kiemtra
 * {
 *     "key": "1",
 *     "ma_toa":"10",
 *     "ten_toa" : "Ten",
